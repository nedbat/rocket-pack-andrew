...
class Guy(Sprite.MultiImageSprite):
    ...
    def update(self):
        ...
        if self.powergun and keys[K_SPACE]:
            bFire = 1
            self.powergun -= 1
            self.powerGunGauge.setValue(self.powergun)
    ...
    def setPowerGunGauge(self, pg):
        self.powerGunGauge = pg
        self.powerGunGauge.setValue(self.powergun)
...
class RocketPackAndrew:
    ...
    def initLevel(self, levelNum):
        ...
        self.guy = newguy
        hg = Gauge(self.sa, maxHealth, (screenWidth-20-230, 20, 230, 20), (255, 0, 0))
        self.guy.setHealthGauge(hg)
        sg = Gauge(self.sa, shieldStrength, (screenWidth-20-230, 45, 230, 20), (0, 0, 255))
        self.guy.setShieldGauge(sg)
        pg = Gauge(self.sa, powerGuns*powerGunBullets, (screenWidth-20-230, 70, 230, 20), (255, 255, 0))
        self.guy.setPowerGunGauge(pg)
